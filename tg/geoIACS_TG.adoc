...
|===
a|image::./media/image1.jpg[image, align=center]
a|[.text-right]#Joint Research Centre#
|===
...
[NOTE]
====
*_TG Recommendation 2_*
*Syntax of unique and persistent identifiers*
...
[.text-center]
*TG Requirement 10*
*Temporal validity of Spatial Objects*
...
[NOTE]
====
*_TG Recommendation 3_*
*Quantitative evaluation of data quality elements*
...
[.text-center]
*TG Requirement 16*
*Application of INSPIRE metadata requirements*
...
[NOTE]
====
*_TG Recommendation 11_*
*Application of INSPIRE metadata recommendations*
...
[.text-center]
*TG Requirement 17*
*Publication of metadata of geoIACS datasets or dataset series*
...
[NOTE]
====
*_TG Recommendation 12_*
*Abstract of geoIACS historic datasets*
...
[NOTE]
====
*_TG Recommendation 13_*
*Abstract of geoIACS historic dataset series*
...
[NOTE]
====
*_TG Recommendation 14_*
*Legal references in the abstract*
...
[.text-center]
*TG Requirement 20*
*INSPIRE data themes for geoIACS datasets or series*
...
[.text-center]
*TG Requirement 21*
*Mandatory keywords from GEMET for geoIACS datasets or series*
...
[.text-center]
*TG Requirement 22*
*Other mandatory keywords for geoIACS datasets or series*
...
[NOTE]
====
*_TG Recommendation 15_*
*Recommended value of the temporal reference of geoIACS datasets*
...
[.text-center]
*TG Requirement 24*
*Mandatory value of the temporal reference type of the geoIACS datasets*
...
[.text-center]
*TG Requirement 25*
*Updating the value of the last revision date metadata element for a geoIACS dataset*
...
[.text-center]
*TG Requirement 26*
*Value of last revision date of geoIACS datasets*
...
[.text-center]
*TG Requirement 27*
*Minimum frequency of publishing the updated geoIACS datasets*
...
[NOTE]
====
*_TG Recommendation 16_*
*Accessibility of historic geoIACS datasets*
...
[.text-center]
*TG Requirement 28*
*Temporal reference of geoIACS dataset series*
...
[.text-center]
*TG Requirement 29*
*Spatial resolution of geoIACS datasets*
...
[.text-center]
*TG Requirement 30*
*Specifications against which to evaluate conformity of geoIACS datasets*
...
[.text-center]
*TG Requirement 31*
*Information about confidentiality clauses on geoIACS datasets*
...
[NOTE]
====
*_TG Recommendation 17_*
*Metadata point of contact for geoIACS datasets*
...
[NOTE]
====
*_TG Recommendation 18_*
*Documenting Data Quality of geoIACS datasets*
...
[NOTE]
====
*_TG Recommendation 20_*
*Harmonised geoIACS datasets and series accessibility via APIs*
...
===== Default encoding(s) for geoIACS application schemas
...
[NOTE]
====
*_TG Recommendation 21_*
*Use of GeoPackage encoding_*
...
[NOTE]
====
*_TG Recommendation 22_*
*Keywords in Layers Metadata parameters of the INSPIRE View service_*
